...
[**Página com arquivo do script em RMarkdown**](https://github.com/lucastoshioito/lucastoshioito.github.io/blob/main/Tutorial_graphPRS/Code.Rmd)
...
- [**test.best:**](https://lucastoshioito.github.io/Tutorial_graphPRS/test.best) exportado pelo PRSice (output.best) e contém os escores de risco para cada indivíduo no melhor p-threshold
- [**test.summary:**](https://lucastoshioito.github.io/Tutorial_graphPRS/test.summary) exportado pelo PRSice (output.summary) e contém qual p-threshold foi utilizado, o número de SNPs, valor de p e R^2 do modelo, ...
- [**test_pheno:**](https://lucastoshioito.github.io/Tutorial_graphPRS/test_pheno) arquivo de fenótipos que foi utilizado no PRSice no comando --pheno
